...
class TestNetworkAdapterCollection(unittest.TestCase):
    ...
    def setUp(self, oneview_client_mockup):
        ...
        self.app.register_blueprint(network_adapter_collection)
    ...
    def test_get_network_adapter_collection(self, get_oneview_client_mockup):
    ...
    @mock.patch.object(util, 'get_oneview_client')
    def test_get_network_adapter_collection_sh_not_found(
    ...
    @mock.patch.object(util, 'get_oneview_client')
    def test_get_network_adapter_collection_sh_exception(
        self, get_oneview_client_mockup):
        """Tests NetworkAdapterCollection"""
